...
## Installation
You can install scDEED from GitHub using devtools. It should install in 1 minute, but may take longer if you need to update dependencies. If you do not want to update all packages (especially Seurat, e.g., its version 5.2.1 was reportedly different from version 5.1.0), then please do not selection option 1 when asked which packages you would like to update. You can specify which packages you would like to update by entering the numbers. 
